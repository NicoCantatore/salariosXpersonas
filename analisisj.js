...
// Mediana del top 10%
const spliceStart = (salariosArgSorted.length * 90) / 100; // 90 el porcentaje a quitar desde el 90 %
const spliceCount = salariosArgSorted.length - spliceStart;

const salariosArgTop10 = salariosArgSorted.splice( //2 argumentos el primero se posiciona en el array  el 2 elige cuando va sacar y va a guardar
    spliceStart,
    spliceCount,
);
